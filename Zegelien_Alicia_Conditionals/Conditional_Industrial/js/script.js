...
if(oneYearRatio <= 6){
	console.log("You can be in a room by yourself.");  //if statement
}else if(oneYearRatio > 6 && oneYearRatio <= 12){
	console.log("You can be in the room with two people."); //else if statement
}else{
	console.log("Send what you are over to another classroom."); //else statement
}